...
| 09-08 | **「乗れる社がいる」と「実際にその便で組める」は別物として扱う。** 全区間で選べるのがANAだけ＋日本発の途中降機を含む旅程は ⚠️ 要確認とし、成立と言い切らない（公式が沈黙しているため fail-safe を厳しい側へ） |
...
| 3 | `REQ-人手` | 👤 **あなたがやる** | **ANAに確認：ANA便だけの旅程を提携（スタアラ）特典として発券できるか。** 公式サイトは沈黙している。確定すれば ⚠️ を ✅ か ❌ に倒せる | ⚠️ 要確認のまま（安全側だが、本当は使える案を使わずに終わる可能性） |
